      ...
      <div className="w-full flex flex-col items-center">
        ...
        <div className={`${state === 'p1' ? 'opacity-100' : 'opacity-0 invisible hidden'} flex flex-wrap w-full justify-center select-none pt-6`}>
          {allDocuments && allDocuments.map((document) => (
            <div key={document._id} onClick={() => handleDocumentClick(document._id)} className="card m-3 p-4 cursor-pointer hover:bg-gray-4 hover:opacity-100 opacity-80 transition-opacity duration-300">
              <div className="flex justify-between">
                ...
                <div>
                  <div className="text-xs bg-gray-2 p-1 rounded-full px-2 font-mono">
                    {document._id}
                  </div>
              ...
              <div className="bg-gray-2 p-3 rounded-md mt-2 flex flex-col gap-2">
                <p className="">
                  <span className="w-full badge badge-flat-primary font-semibold">
                ...
                <p className="">
                  <span className="w-full badge text-gray-100/70 font-semibold">
