            ...
            <div className="min-h-0">
                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'evaluacionApoyos', formValues, 'Efectividad de Apoyos, Personales')}>
                    <div className="w-full">
                        ...
                        <textarea id="PERefectividad" value={formValues.PERefectividad || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={100} placeholder="Efectividad" rows="2" ></textarea>
                        <textarea id="PERcontinuidad" value={formValues.PERcontinuidad || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={100} placeholder="Observaciones" rows="2" ></textarea>
                    </div>
                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'evaluacionApoyos', formValues, 'Efectividad de Apoyos, Curriculares')}>
                    <div className="w-full">
                        ...
                        <textarea id="CURefectividad" value={formValues.CURefectividad || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={100} placeholder="Efectividad" rows="2" ></textarea>
                        <textarea id="CURcontinuidad" value={formValues.CURcontinuidad || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={100} placeholder="Observaciones" rows="2" ></textarea>
                    </div>
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div id="group1" className="flex flex-col gap-3 items-center">
                            <label className="self-start" htmlFor="RUN">Continuidad:</label>
                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'evaluacionApoyos', formValues, 'Efectividad de Apoyos, Medios y Recursos Materiales')}>
                    <div className="w-full">
                        ...
                        <textarea id="MRMefectividad" value={formValues.MRMefectividad || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={100} placeholder="Efectividad" rows="2" ></textarea>
                        <textarea id="MRMcontinuidad" value={formValues.MRMcontinuidad || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={100} placeholder="Observaciones" rows="2" ></textarea>
                    </div>
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div id="group1" className="flex flex-col gap-3 items-center">
                            <label className="self-start" htmlFor="RUN">Continuidad:</label>
                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'evaluacionApoyos', formValues, 'Efectividad de Apoyos, Organizativos')}>
                    <div className="w-full">
                        ...
                        <textarea id="ORGefectividad" value={formValues.ORGefectividad || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={100} placeholder="Efectividad" rows="2" ></textarea>
                        <textarea id="ORGcontinuidad" value={formValues.ORGcontinuidad || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={100} placeholder="Observaciones" rows="2" ></textarea>
                    </div>
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div id="group1" className="flex flex-col gap-3 items-center">
                            <label className="self-start" htmlFor="RUN">Continuidad:</label>
                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'evaluacionApoyos', formValues, 'Efectividad de Apoyos, Familiares')}>
                    <div className="w-full">
                        ...
                        <textarea id="FAMefectividad" value={formValues.FAMefectividad || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={100} placeholder="Efectividad" rows="2" ></textarea>
                        <textarea id="FAMcontinuidad" value={formValues.FAMcontinuidad || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={100} placeholder="Observaciones" rows="2" ></textarea>
                    </div>
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div id="group1" className="flex flex-col gap-3 items-center">
                            <label className="self-start" htmlFor="RUN">Continuidad:</label>
                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'evaluacionApoyos', formValues, 'Efectividad de Apoyos, Otros Apoyos')}>
                    <div className="w-full">
                        ...
                        <textarea id="OAefectividad" value={formValues.OAefectividad || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={100} placeholder="Efectividad" rows="2" ></textarea>
                        <textarea id="OAcontinuidad" value={formValues.OAcontinuidad || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={100} placeholder="Observaciones" rows="2" ></textarea>
                    </div>
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div id="group1" className="flex flex-col gap-3 items-center">
                            <label className="self-start" htmlFor="RUN">Continuidad:</label>
