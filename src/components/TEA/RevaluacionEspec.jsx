                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'revaluacion', formValues, 'Área Interacción Social')}>
                    ...
                    <div className="w-full flex flex-wrap items-start mb-3 gap-1">
                        ...
                        <div className='w-full flex flex-col gap-3 items-start'>
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="IStxtObsContextoEscolar" value={formValues.IStxtObsContextoEscolar} onChange={handleInputChange} />
                        </div>
                        <div className='w-full flex flex-col gap-3 items-start'>
                            <label className="flex items-end cursor-pointer gap-2">
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="IStxtAplicacionInstrumento" value={formValues.IStxtAplicacionInstrumento} onChange={handleInputChange} />
                        </div>
                    </div>
                    <div className="w-full">
                        <label className="sr-only" htmlFor="progresos">Progresos</label>

                        <textarea id="ISprogresos" value={formValues.ISprogresos || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={330} placeholder="Describa los progresos en el comportamiento del o la estudiante en esta área" rows="8" ></textarea>
                    </div>

                    <div className="w-full">
                        <label className="sr-only" htmlFor="enfasis">Énfasis</label>

                        <textarea id="ISaspectosEnfasis" value={formValues.ISaspectosEnfasis || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={250} placeholder="Describa aquellos aspectos de esta área a los cuales darle énfasis durante el próximo periodo académico" rows="8" ></textarea>
                    </div>
                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'revaluacion', formValues, 'Área Lenguaje y Comunicación')}>
                    ...
                    <div className="w-full flex flex-wrap items-start mb-3 gap-1">
                        ...
                        <div className='w-full flex flex-col gap-3 items-start'>
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="LCtxtObsContextoEscolar" value={formValues.LCtxtObsContextoEscolar} onChange={handleInputChange} />
                        </div>
                        <div className='w-full flex flex-col gap-3 items-start'>
                            <label className="flex items-end cursor-pointer gap-2">
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="LCtxtAplicacionInstrumento" value={formValues.LCtxtAplicacionInstrumento} onChange={handleInputChange} />
                        </div>
                    </div>
                    ...
                    <div className="w-full">
                        ...
                        <textarea id="LCprogresos" value={formValues.LCprogresos || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={330} placeholder="Describa los progresos del o la estudiante en esta área (ej: comunicación verbal y no verbal, nivel semántico y pragmático, desempeño comunicativo, entre otros)" rows="8" ></textarea>
                    </div>

                    <div className="w-full">
                        <label className="sr-only" htmlFor="progresos">Enfasis</label>

                        <textarea id="LCaspectosEnfasis" value={formValues.LCaspectosEnfasis || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={250} placeholder="Describa aquellos aspectos de esta área a los cuales darle énfasis durante el próximo periodo académico" rows="8" ></textarea>
                    </div>
                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'revaluacion', formValues, 'Área Cognitiva')}>
                    ...
                    <div className="w-full flex flex-wrap items-start mb-3 gap-1">
                        ...
                        <div className='w-full flex flex-col gap-3 items-start'>
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="CtxtObsContextoEscolar" value={formValues.CtxtObsContextoEscolar || ""} onChange={handleInputChange} />
                        </div>
                        <div className='w-full flex flex-col gap-3 items-start'>
                            <label className="flex items-end cursor-pointer gap-2">
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="CtxtAplicacionInstrumento" value={formValues.CtxtAplicacionInstrumento || ""} onChange={handleInputChange} />
                        </div>
                    </div>
                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'revaluacion', formValues, 'Procesamiento Sensorial')}>
                    ...
                    <div className="w-full flex flex-wrap items-start mb-3 gap-1">
                        ...
                        <div className='w-full flex flex-col gap-3 items-start'>
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="PStxtObsContextoEscolar" value={formValues.PStxtObsContextoEscolar || ""} onChange={handleInputChange} />
                        </div>
                        <div className='w-full flex flex-col gap-3 items-start'>
                            <label className="flex items-end cursor-pointer gap-2">
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="PStxtAplicacionInstrumento" value={formValues.PStxtAplicacionInstrumento || ""} onChange={handleInputChange} />
                        </div>
                    </div>
                    ...
                    <div className="w-full">
                        ...
                        <textarea id="PSprogresos" value={formValues.PSprogresos || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={330} placeholder="Describa los progresos del o la estudiante en esta área (ej: táctil, auditiva, visual, vestibular, entre otros)" rows="8" ></textarea>
                    </div>

                    <div className="w-full">
                        <label className="sr-only" htmlFor="aspectosEnfasis">enfasis</label>

                        <textarea id="PSaspectosEnfasis" value={formValues.PSaspectosEnfasis || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={250} placeholder="Describa aquellos aspectos de esta área a los cuales darle énfasis durante el próximo periodo académico" rows="8" ></textarea>
                    </div>
                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'revaluacion', formValues, 'Área Motora')}>
                    ...
                    <div className="w-full flex flex-wrap items-start mb-3 gap-1">
                        ...
                        <div className='w-full flex flex-col gap-3 items-start'>
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="MtxtObsContextoEscolar" value={formValues.MtxtObsContextoEscolar || ""} onChange={handleInputChange} />
                        </div>
                        <div className='w-full flex flex-col gap-3 items-start'>
                            <label className="flex items-end cursor-pointer gap-2">
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="MtxtAplicacionInstrumento" value={formValues.MtxtAplicacionInstrumento || ""} onChange={handleInputChange} />
                        </div>
                    </div>
                    ...
                    <div className="w-full">
                        ...
                        <textarea id="Mprogresos" value={formValues.Mprogresos || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={330} placeholder="Describa los progresos del o la estudiante en esta área" rows="8" ></textarea>
                    </div>

                    <div className="w-full">
                        <label className="sr-only" htmlFor="aspectosEnfasis">enfasis</label>

                        <textarea id="MaspectosEnfasis" value={formValues.MaspectosEnfasis || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={250} placeholder="Describa aquellos aspectos de esta área a los cuales darle énfasis durante el próximo periodo académico" rows="8" ></textarea>
                    </div>
                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'revaluacion', formValues, 'Área Académica Funcional')}>
                    ...
                    <div className="w-full flex flex-wrap items-start mb-3 gap-1">
                        ...
                        <div className='w-full flex flex-col gap-3 items-start'>
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="AFtxtObsContextoEscolar" value={formValues.AFtxtObsContextoEscolar || ""} onChange={handleInputChange} />
                        </div>
                        <div className='w-full flex flex-col gap-3 items-start'>
                            <label className="flex items-end cursor-pointer gap-2">
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="AFtxtAplicacionInstrumento" value={formValues.AFtxtAplicacionInstrumento || ""} onChange={handleInputChange} />
                        </div>
                    </div>
                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'revaluacion', formValues, 'Área de Desempeño Personal y Social')}>
                    ...
                    <div className="w-full flex flex-wrap items-start mb-3 gap-1">
                        ...
                        <div className='w-full flex flex-col gap-3 items-start'>
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="DPStxtObsContextoEscolar" value={formValues.DPStxtObsContextoEscolar || ""} onChange={handleInputChange} />
                        </div>
                        <div className='w-full flex flex-col gap-3 items-start'>
                            <label className="flex items-end cursor-pointer gap-2">
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="DPStxtAplicacionInstrumento" value={formValues.DPStxtAplicacionInstrumento || ""} onChange={handleInputChange} />
                        </div>
                    </div>
                    ...
                    <div className="w-full">
                        ...
                        <textarea id="DPSprogresos" value={formValues.DPSprogresos || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={330} placeholder="Describa los progresos del o la estudiante en esta área" rows="8" ></textarea>
                    </div>

                    <div className="w-full">
                        <label className="sr-only" htmlFor="aspectosEnfasis">enfasis</label>

                        <textarea id="DPSaspectosEnfasis" value={formValues.DPSaspectosEnfasis || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={250} placeholder="Describa aquellos aspectos de esta área a los cuales darle énfasis durante el próximo periodo académico" rows="8" ></textarea>
                    </div>
                ...
                <form className="space-y-4 mt-2 mb-6 px-1" onSubmit={(e) => updateDocument(e, 'revaluacion', formValues, 'Contexto Familiar y Social del Estudiante')}>
                    ...
                    <div className="w-full flex flex-wrap items-start mb-3 gap-1">
                        ...
                        <div className='w-full flex flex-col gap-3 items-start'>
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="CFStxtObsContextoEscolar" value={formValues.CFStxtObsContextoEscolar || ""} onChange={handleInputChange} />
                        </div>
                        <div className='w-full flex flex-col gap-3 items-start'>
                            <label className="flex items-end cursor-pointer gap-2">
                            ...
                            <input className="bg-gray-2 rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none pl-3 placeholder:text-gray-9 capitalize" placeholder="" maxLength={16} type="text" id="CFStxtAplicacionInstrumento" value={formValues.CFStxtAplicacionInstrumento || ""} onChange={handleInputChange} />
                        </div>
                    </div>
                    ...
                    <div className="w-full">
                        ...
                        <textarea id="CFSprogresos" value={formValues.CFSprogresos || ""} onChange={handleInputChange} className="bg-gray-2 w-full rounded-xl p-2 hover:bg-gray-1 focus:bg-gray-1 outline-none placeholder:text-gray-9 textarea-solid max-w-full" maxLength={330} placeholder="Describa aquellos aspectos destacados respecto a la participación de la familia en los progresos del o la estudiante." rows="8" ></textarea>
                    </div>
